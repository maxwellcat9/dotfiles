...
(custom-set-variables
 ...
 '(package-selected-packages
   '(beancount breadcrumb corfu counsel-projectile dark-mint-theme emms
	       evil-collection exwm general helpful hydra ivy-rich
	       lua-mode magit org-bullets pdf-tools
	       phoenix-dark-pink-theme rainbow-delimiters
	       saveplace-pdf-view visual-fill visual-fill-column
	       which-key-posframe)))
(custom-set-faces
